...
const DailyHoroscope = () => {
  ...
  const handlePrint = () => {
    ...
    document.title = `Daily Horoscope Report - ${userName}`;
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      toast.error("Error fetching Daily Horoscope Data", {
        position: "top-right",
      });
      setShowForm(true);
    } finally {
                  ...
                  {isHoroscopeOpen && (
                    <motion.div className="horoscope-content">
                      <div className="horoscope-detail">
                        <span className="horoscope-label">{"Date"}:</span>
                        <span className="horoscope-value">
                          {horoscope?.data?.response?.date || "N/A"}
                        </span>
                      </div>
                      <div className="horoscope-detail">
